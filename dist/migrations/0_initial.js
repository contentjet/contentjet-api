...
async function createUserTable(_knex) {
...
async function createProjectTable(_knex) {
...
async function createProjectMembershipTable(_knex) {
...
async function createWebhookTable(_knex) {
...
async function createProjectinviteTable(_knex) {
...
async function createMediatagTable(_knex) {
...
async function createMediaTable(_knex) {
...
async function createMedia_MediatagTable(_knex) {
...
async function createEntrytypeTable(_knex) {
...
async function createEntrytagTable(_knex) {
...
async function createEntryTable(_knex) {
...
async function createEntry_EntrytagTable(_knex) {
...
async function createPermissionTable(_knex) {
...
async function createRoleTable(_knex) {
...
async function createRole_PermissionTable(_knex) {
...
async function createUser_RoleTable(_knex) {
